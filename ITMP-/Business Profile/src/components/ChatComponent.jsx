...
const styles = {
  chatContainer: {
    ...
    color: '#545454', // Slightly dark text for contrast
  },
  messagesList: {
    overflowY: 'auto',
    flexGrow: 1,
  ...
  myMessage: {
    background: '#F57C00', // Deeper orange for the sender
    color: 'white',
    padding: '10px',
    borderRadius: '10px',
    maxWidth: '70%',
  ...
  theirMessage: {
    background: '#FFE0B2', // Lighter orange for the receiver
    padding: '10px',
    borderRadius: '10px',
    maxWidth: '70%',
  },
  ...
  messageTime: {
    fontSize: '12px',
    marginTop: '8px',
    color: '#A1887F', // Complementary color for the time
    textAlign: 'right',
  },
  messageForm: {
    display: 'flex',
    padding: '20px',
    borderTop: '1px solid #F57C00', // Border to match the theme
  },
  messageInput: {
    flexGrow: 1,
    marginRight: '10px',
  ...
  sendMessageButton: {
    background: '#EF6C00', // Vibrant orange for the button
    color: 'white',
    border: 'none',
    borderRadius: '20px',
    padding: '10px 20px',
